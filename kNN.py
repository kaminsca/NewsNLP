...
# encodings = tokenizer(df['content'].tolist(), padding="max_length", truncation=True, max_length=64)
# X_train, X_test, y_train, y_test = train_test_split(encodings, df['combined_label'], test_size=0.2, random_state=42)
